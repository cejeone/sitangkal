...
const About = () => {
    return (
        <section className="tentang-sitangkal mt-5 mb-5">
            <div className="container mx-auto my-5 relative">
                <div className="judul-tentang grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-5 py-5 mt-5 mb-5 relative z-10 ">
                    <div className="judul py-4">
                        <span className="badge badge-outline badge-neutral">Portal</span>
                        <h1 className="text-4xl font-bold py-5">Tentang SiTangkal</h1>
                    </div>
                ...
                <div className="fitur flex flex-col justify-center items-center mt-5 mb-5 relative z-10 ">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1">
                    <div className="card card-border border-neutral-300 bg-base-100 w-auto rounded-xl">
